...
export const walkRoute: Route = {
  ...
  path: [[35.15, 129.06], [35.151, 129.061], [35.151, 129.07]],
}
...
export const response: RouteSearchResponse = {
  ...
  routes: [walkRoute, { ...walkRoute, id: 'route_2', rank: 2, badges: ['shortest_walk'], cautions: [] }],
  metadata: { profile: 'wheelchair', profile_label: '휠체어 이용자', weather_flags: ['heatwave', 'heat'], departure_at: null, corridor_nodes: 418, corridor_edges: 1540, blocked_edges: 140, snap_origin_m: 1, snap_destination_m: 2, shade_status: 'computed', shade_note: '', solar_elevation_deg: 71, building_height_coverage: 0.97, elevation_resolution_m: 90, aco: {}, ga: {}, archive_size: 394, elapsed_ms: 130 },
}
